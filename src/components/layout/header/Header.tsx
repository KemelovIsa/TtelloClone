			...
			<header className="header">
				<div className="head">
					...
					<div className="searchContainer">
						...
						<img
							className="kolokol"
							src="src/assets/bell-ringing-2.png"
							alt="колокол"
						/>
						<img
							className="infoICons"
							src="src/assets/question-mark.png"
							alt="informatsia"
						/>
						{isCompleted ? (
							<button className="Btn">
								...
								<div onClick={LogOut} className="text">
									Выйти
								</div>
							</button>
						) : (
